...
import { ArrowLeft, ChefHat, Loader2, Sparkles, AlertCircle, TrendingUp, Package} from "lucide-react";
...
export default function PantryRecipesPage() {
  const { loading, data: recipesData, fn: fetchSuggestions } = useFetch(getRecipesByPantryIngredients);
        ...
        {!loading && recipes.length > 0 && (
          <div>
            <div className="flex items-center justify-between mb-6">
              ...
              <Badge variant="outline" className="border-2 border-stone-900 text-stone-900 font-bold uppercase tracking-wide">
            ...
            <div className="mt-8 text-center">
              <Button onClick={() => fetchSuggestions(new FormData())} variant="outline" className="border-2 border-stone-900 hover:bg-stone-900 hover:text-white gap-2" disabled={loading}>
                {loading ? (
                  <>
        ...
        {!loading && recipes.length === 0 && recipesData?.success === false && (
          <div className="bg-white p-12 text-center border-2 border-dashed border-stone-200">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/pantry">
                <Button variant="outline" className="border-2 border-stone-900 hover:bg-stone-900 hover:text-white gap-2">
                  Add Manually
                </Button>
              </Link>
            </div>
